                        ...
                        <div class="row center ">
                            <div class="col-md-6 col-sm-12">
                                <div class="card">
                                    <div class="card-body">
                                        <img
                                            src="/storage/chiens/{{$images[$key]["dad"]->slug}}{{$images[$key]["dad"]->ext}}"
                                            class="d-block w-100"
                            ...
                            <div class="col-md-6  col-sm-12">
                                <div class="card">
                                    <div class="card-body">
                                        <img
                                            src="/storage/chiens/{{$images[$key]["mom"]->slug}}{{$images[$key]["mom"]->ext}}"
                                            class="d-block w-100"
                                        ...
                                        <a href="{{route('details', ['id' => $chiot->id])}}">
                                            <div class="card">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <div class="center">
                                                        <img
                                                            src="{{url('/storage/img/pate.png')}}" class="pate "
