<?php $__env->startSection('content'); ?>
    <div class="row">
        ...
        <div class="col-md-6 col-sm-12">
            <img class="img-thumbnail" src="<?php echo e(url('/storage/img/Les3.png')); ?>"
    ...
    <div class="row">
        <div class="card mb-3" style="max-width: 540px;">
            <div class="row no-gutters">
                <div class="col-md-4">
                    <img src="<?php echo e(url('/storage/img/maman.png')); ?>" class="card-img" alt="...">
                </div>
                <div class="col-md-8">
                    <div class="card-body">
        ...
        <div class="card md-3" style="max-width: 540px;">
            <div class="row no-gutters">
                ...
                <div class="col-md-4 ">
                    ...
                    <img src="<?php echo e(url('/storage/img/emile.png')); ?>" width="200px" height="318px" class="card-img"
                         alt="...">
    ...
    <div class="row">
        ...
        <p>Nous avons eu notre premier <strong>Berger Australien</strong> début 2012. C’était une petite boule de poils âgée de trois mois, très attachante et très gentille, qui se nomme <a href="<?php echo e(route('details', ['id' => 1])); ?>">GEO de la Lauze aux Micocouliers</a>.</p>
        ...
        <p>Puis, nous avons voulu agrandir la famille, et de là est arrivée <a href="<?php echo e(route('details', ['id' => 13])); ?>">LITTLE BLACK SWAN</a> « dit <a href="<?php echo e(route('details', ['id' => 13])); ?>">SWAN</a> » des Allées Brumeuses, <strong>Berger Australien</strong> femelle, que nous avons eue fin 2015 à l’âge de trois mois.</p>
        ...
        <p>Nous avons pris une troisième femelle cet été, notre petite <a href="<?php echo e(route('details', ['id' => 2])); ?>">NEEDED ME</a> «  dit <a href="<?php echo e(route('details', ['id' => 2])); ?>">NEED</a> » of Falnette History, âgée alors de cinq mois.</p>
    ...
    <div class="row">
        ...
        <div class="card col-12">
            <div class="row no-gutters">
                <div class="col-6">
                    <img src="<?php echo e(url('/storage/img/1.jpg')); ?>" class="card-img" alt="...">
                </div>
                <div class="col-md-6">
                    <div class="card-body">
    ...
    <div class="row right">
        <div class="card col-12">
            <div class="row no-gutters">
                ...
                <div class="col-6">
                    <img src="<?php echo e(url('/storage/img/5.jpg')); ?>" class="card-img" alt="...">
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="card col-12">
            <div class="row no-gutters">
                <div class="col-6">
                    <img src="<?php echo e(url('/storage/img/3.jpg')); ?>" class="card-img" alt="...">
                </div>
                <div class="col-md-6">
                    <div class="card-body">
